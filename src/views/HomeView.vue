        ...
        <div class="lg:col-span-8 space-y-4 h-140 flex w-310 flex-col gap-5">
          ...
          <div class="flex flex-col sm:flex-row gap-4">
            ...
            <div class="sm:w-1/3 bg-[#00B4D8] border border-white/10 rounded-2xl p-4">
              ...
              <p v-if="weather" class="text-sm text-white">{{ weather.name }},</p>
            ...
            <div
              v-if="weekly.length"
              class="flex-grow flex justify-between bg-[#00B4D8] border border-white/10 rounded-2xl p-10 overflow-x-auto"
            >
              <div
          ...
          <!-- NEARBY PROVINCES -->
          <div
            class="border border-white/10 flex flex-row bg-[#CAF0F8] p-4 h-[300px] items-center justify-center gap-10 relative"
          >
            ...
            <div class="lg:col-span-4 space-y-4 w-100">
              <div class="space-y-2 flex flex-col gap-2">
                ...
                >
                  ...
                  <div class="flex items-center gap-3">
                    <img
                      :src="`https://openweathermap.org/img/wn/${prov.icon}@2x.png`"
                      class="h-6 w-6"
                    />
...
/* TIME */
const dayName = computed(() => new Date().toLocaleDateString('en-US', { weekday: 'long' }))
